...
function createUser(username, score){
    this.username = username  // this keyword set current context. like talking about which username key word
    this.score = score
}
...
const chai = new createUser("chai", 25)  // new keyword solve this error :TypeError: Cannot read properties of undefined (reading 'printMe')
